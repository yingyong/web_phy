...
;(function ($) {
  ...
  $.widget('ui.jqcarousel', {
    ...
    options: {
      ...
      imageWidth: 500,
	//imageWidth: $( window ).width()/3,
      direction: 'shortest',
      enlargeWidth: 700,
	 //enlargeWidth:$( window).width()/2,
      enlargeDuration: 200,
      closeDuration: 250,
      closeButtonSize: 30,
      enlargeEnabled: true,
    ...
    _performElementLayout: function () {
		//alert("window ="+$( window ).width()+" ==="+$( document ).width());
...
//	  this.element.css("background-color","pink");
    },
